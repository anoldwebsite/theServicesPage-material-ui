...
const useStyles = makeStyles(theme => ({
    ...
    background: {
        ...
        backgroundAttachment: "fixed",/* The background-attachment CSS property sets whether a background image's position is fixed within the viewport, or scrolls with its containing block. */
...
export default function CallToAction(props) {
    ...
    return (
        <Grid container alignItems="center" justify={matchesSM ? "center" : "space-between"} className={classes.background} direction={matchesSM ? "column" : "row"}>{/* Grid has the Default direction of row */}
